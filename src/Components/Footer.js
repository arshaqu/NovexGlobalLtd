...
function Footer() {
  ...
  <div className="grid grid-cols-2 gap-25">
    ...
    <div className="space-y-4 t">
      <a  style={{fontWeight:'300'}}  href="/" className="block text-white hover:text-red-300 transition-colors text-sm lg:text-lg sm:text-base font-medium">
        HOME
      </a>
      <a style={{fontWeight:'300'}}  href="/services" className="block text-white hover:text-red-300 transition-colors text-sm lg:text-lg sm:text-base font-medium">
        SERVICES
      </a>
      <a style={{fontWeight:'300'}}  href="/products" className="block text-white hover:text-red-300 transition-colors text-sm lg:text-lg sm:text-base font-medium">
        PRODUCTS
      </a>
    ...
    <div className="space-y-4">
     ...
     <a style={{fontWeight:'300'}}  href="/careers" className="block text-white hover:text-red-300 transition-colors text-sm lg:text-lg sm:text-base font-medium">
      ...
      <a style={{fontWeight:'300'}}  href="/contact" className="block text-white hover:text-red-300 transition-colors text-sm lg:text-lg sm:text-base font-medium">
        CONTACT
      </a>
      <a style={{fontWeight:'300'}}  href="/contact" className="block text-white hover:text-red-300 transition-colors text-sm lg:text-lg sm:text-base font-medium">
        LOCATION
