          ...
          <div className="lg:w-1/2 bg-white rounded-lg shadow-lg p-6 lg:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 mt-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input style={{border:'1px solid #E3001B' , fontWeight:'300'}} type="text" name="name" placeholder="Your Name" value={formData.name} onChange={handleChange} className="w-full px-8 py-4 border border-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-[#E3001B] focus:border-transparent text-md lg:textmd" required />
                <input style={{border:'1px solid #E3001B' , fontWeight:'300'}} type="email" name="email" placeholder="Your Email" value={formData.email} onChange={handleChange} className="w-full px-8 py-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#E3001B] focus:border-transparent text-md lg:text-xl" required />
              </div>
