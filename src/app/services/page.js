    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="bg-[#E3001B] text-white py-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="max-w-4xl mx-auto text-lg md:text-xl opacity-95">
      ...
      <section className=" max-w-8xl mx-auto p-5">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 mt-10">
          ...
          <div style={{border:'2px solid #E3001B' ,backgroundColor:'#ffffff'}} className=" rounded-2xl p-8 hover:shadow-lg transition">
            <h3 className="text-2xl font-semibold text-[#E3001B] mb-4 ">
              B2B Wholesale Supply
            </h3>
            <p style={{fontWeight:'400'}} className="text-[#E3001B] text-lg leading-relaxed ">
          ...
          {/* Trade Accounts */}
          <div style={{border:'2px solid #E3001B'}} className=" rounded-2xl p-8 hover:shadow-lg transition">
            <h3 className="text-2xl font-semibold text-[#E3001B] mb-4">
              Trade Account Management
            </h3>
            <p style={{fontWeight:'400'}} className="text-red-500 leading-relaxed">
          ...
          <div style={{border:'2px solid #E3001B'}} className=" rounded-2xl p-8 hover:shadow-lg transition">
            ...
            <p style={{fontWeight:'400'}} className="text-red-600 leading-relaxed">
      ...
      <section style={{backgroundColor:"#ffffff"}} className=" py-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left">
            ...
            <div className="bg-[#E3001B] lg:text-2xl text-white p-6 rounded-xl border">
      ...
      <section className="py-20 bg-gray-100 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold text-[#E3001B] mb-4">
          ...
          <button className="bg-[#E3001B] text-white px-8 py-3 rounded-xl font-semibold hover:scale-[1.03] active:scale-[0.97] transition">
